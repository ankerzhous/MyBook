...
![](D:\笔记本\我的笔记\java框架\images\springMVC.png)
...
在web.xml中默认配置的dispatcherServlet会将所有请求拦截，静态资源也被拦截了，增进一个配置，把js结尾的文件用默认servlet去配置。
